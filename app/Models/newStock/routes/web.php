...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // request
    //Route::delete('requests/destroy', 'RequestController@massDestroy')->name('request.massDestroy');
    Route::resource('request', 'RequestController');
    // 
    Route::resource('requestList', 'RequestListController');
    ...
    Route::resource('assetsReport', 'AssetsReportController');
    // Transactions
